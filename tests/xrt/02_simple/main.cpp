...
run(int argc, char** argv)
{
  ...
  std::cout << "debugg " << uuid.to_string() << " " << device_index << " "  << uuid.get()  << "\n";
...
int main(int argc, char** argv)
{
  ...
  try {
    ...
    std::cout << "FAILED TEST yyy \n";
    return 1;
  }

  std::cout << "PASSED TEST zzz \n";
  return 0;
}
